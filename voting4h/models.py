...
class Profile(models.Model):
    ...
    vote_unique = models.ForeignKey(Pet, on_delete=models.CASCADE, related_name="unique", blank=True, null=True)
    vote_people_choice = models.ForeignKey(Pet, on_delete=models.CASCADE, related_name="people_choice", blank=True, null=True)
    vote_cutest = models.ForeignKey(Pet, on_delete=models.CASCADE, related_name="cutest", blank=True, null=True)
